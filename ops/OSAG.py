...
# Last Modified:  Thursday, 20th April 2023 9:28:50 am
...
class OSAG(nn.Module):
    def __init__(self, channel_num=64, bias = True, block_num=4,**kwargs):
        ...
        for _ in range(block_num):
            temp_res = block_class(channel_num,bias,kernel_size,ffn_bias=ffn_bias,window_size=window_size,with_pe=pe)
